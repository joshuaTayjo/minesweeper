...
class Cell:
    ...
    def create_cell_count_label(location):
        lbl = Label(location, bg='black', fg='white', text=f'Cells Left: {Cell.cell_count}',
                    width=12, height=4, font=('Arial', 32))
    ...
    def surrounded_cells(self):
        cells = [self.get_cell_by_axis(self.x - 1, self.y - 1), self.get_cell_by_axis(self.x - 1, self.y),
                 ...
                 self.get_cell_by_axis(self.x, self.y + 1), self.get_cell_by_axis(self.x + 1, self.y - 1),
                 self.get_cell_by_axis(self.x + 1, self.y), self.get_cell_by_axis(self.x + 1, self.y + 1)]
